...
public class MostPickupLocationInJan2016 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job1 = Job.getInstance(conf1, "Count Pickup Location in January 2016");
        job1.setInputFormatClass(TextInputFormat.class);

        job1.setJarByClass(MostPickupLocationInJan2016.class);
        ...
        job2.setJarByClass(MostPickupLocationInJan2016.class);
